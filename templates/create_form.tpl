<div class="form" id="event_create">
		...
		<fieldset>
			...
			<dl class="column"> 
				...
				<dd>
					<input type="text" class="inputbox autowidth" name="title" value="{$event_field.title|escape:'htmlall'}" id="event_title_create" />{if isset($error.title)}
					<p class="message-error" id="titleErr">{$error.title}</p>{/if}
		  		</dd> 
				<dt>
					<label for="event_description_create">Event Details</label> 
					<em>What should your guests know?</em>
				</dt>
				<dd>
					<input type="text" class="inputbox autowidth" name="description" id="event_description_create" value="{$event_field.description|escape:'htmlall'}" />{if isset($error.desc)}
				...
				<dd>
					<input type="text" class="inputbox autowidth" name="address" id="event_address_create" value="{$event_field.address|escape:'htmlall'}" />{if isset($error.address)}
				...
				<dd>
					<input type="text" class="inputbox autowidth" name="date" id="event_date_create" value="{$event_field.date}" />{if isset($error.date)}
				...
				<dd>
					<input type="text" class="inputbox autowidth" name="time" id="event_time_create" value="{$event_field.time}" />{if isset($error.time)}
			...
			<dl class="column"> 
				...
				<dd>
					<input type="text" class="inputbox autowidth" name="goal" id="event_goal_create" value="{$event_field.goal|escape:'htmlall'}" />{if isset($error.goal)}
				...
				<dd>
					<input type="text" class="inputbox autowidth" name="deadline" id="event_deadline_create" value="{$event_field.deadline|escape:'htmlall'}" />{if isset($error.deadline)} 
