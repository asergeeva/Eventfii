			...
			<dl class="column"> 
				...
				<dd>
					<label for="event_is_public_yes_create">
						<p><input type="radio" name="is_public" value="1" checked="checked" {if $event_field.permissions eq '1'}checked="checked"{/if} id="event_is_public_yes_create" /> Anyone can sign up and invite others</p>
					</label> 
