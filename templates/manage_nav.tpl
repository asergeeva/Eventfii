<div id="navigation">
			<nav class="manage-nav">
				<ul class="buttons">
					...
					<li><a href="{$CURHOST}/event/manage/email?create=true&amp;eventId={$smarty.session.manage_event->eid}" class="{if isset($page.email)}current {/if}btn btn-nav nav-email"><span><em>Email Guests</em></span></a></li>
