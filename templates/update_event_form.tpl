...
<div id="left_event_form">
    ...
    <h3 class="event_form_section_subheader">Name of event</h3>
		<input type="text" name="updateEvent_title" id="updateEvent_title" value="{$eventInfo['title']}" />
  </div>
  <div class="event_field">
    <h2 class="event_form_section_header">Brief description</h2>
    <h3 class="event_form_section_subheader">What is this event about?</h3>
		<input type="text" name="updateEvent_description" id="updateEvent_description" value="{$eventInfo['description']}" />
  </div>
  <div class="event_field">
    ...
    <h3 class="event_form_section_subheader">Ex: 1234 Maple St, Los Angeles, CA 90007</h3>
		<input type="text" name="updateEvent_address" id="updateEvent_address" value="{$eventInfo['location_address']}" />
  </div>
  <div class="event_field">
    <h2 class="event_form_section_header">When</h2>
    <h3 class="event_form_section_subheader">Ex: 05/14/2011 (MM/DD/YYYY)</h3>
		<input type="text" name="updateEvent_date" id="updateEvent_date" value="{$eventDate}" />
  </div>
  <div class="event_field">
    <h2 class="event_form_section_header">What time</h2>
    <h3 class="event_form_section_subheader">Ex: 21:10:00 (HH:MM:SS)</h3>
		<input type="text" name="updateEvent_time" id="updateEvent_time" value="{$eventTime}" />
  </div>
  <div class="event_field">
    ...
    <h3 class="event_form_section_subheader">Last day for anyone to reserve a spot</h3>
		<input type="text" name="updateEvent_deadline" id="updateEvent_deadline" value="{$eventInfo['event_deadline']}" />
  </div>
</div>
<div id="right_event_form">
	<div class="event_field">
      ...
      <input type="text" name="updateEvent_min_spots" id="updateEvent_min_spots" value="{$eventInfo['min_spot']}" />
    </div>
    <div class="event_field_right">
      ...
      <input type="text" name="updateEvent_max_spots" id="updateEvent_max_spots" value="{$eventInfo['max_spot']}" />
    </div>
  </div>
  <div class="event_field">
    <h2 class="event_form_section_header">Cost per spot</h2>
    <h3 class="event_form_section_subheader">What each attendee pays</h3>
		<input type="text" name="updateEvent_cost" id="updateEvent_cost" value="{$eventInfo['cost']}" />
  </div>
  <div class="event_field_ta">
    ...
    <h3 class="event_form_section_subheader">What each attendee will get once the event goes through</h3>
		<textarea name="updateEvent_gets" id="updateEvent_gets">{$eventInfo['gets']}</textarea>
  </div>
	<div class="event_field">
  	<div class="event_field_left">
      <input type="radio" name="updateEvent_ispublic" id="updateEvent_ispublic_yes" value="1" {$isPublicRadio} />
    ...
    <div class="event_field_right">
      <input type="radio" name="updateEvent_ispublic" id="updateEvent_ispublic_no" value="0" {$isPrivateRadio} />
  ...
  <div class="event_field_pic">
    <h2 class="event_form_section_header_radio">URL</h2>
		<input type="text" name="updateEvent_url" id="updateEvent_url" disabled="disabled" value="{$eventInfo['url']}" />
  </div>
  <div class="event_field_pic">
