...
<div id="container">
	...
	<article class="static">
		...
		<section>
			...
			<section>
				<header>
					<h1>Our Use of Information That We Collect:</h1>
				</header>
				<ol>
					<li>
						<h2>Personal Data:</h2>
						<p>Company uses the Personal Data we collect in a manner that is consistent with this Privacy Policy. Company may use the Personal Data as follows:</p>
