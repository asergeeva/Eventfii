				...
				<fieldset>
					<legend>Edit Event</legend>
						<dl class="column"> 		
							...
							<dd>
                                <input type="text" class="inputbox autowidth" name="title" value="{$event_field['title']}" id="event_title_update" />
							...
							<dd>
                                    <input type="text" class="inputbox autowidth" name="description" value="{$event_field['description']}" id="event_description_update" />
							...
							<dd>
                                <input type="text" class="inputbox autowidth" name="address" value="{$event_field['address']}" id="event_address_update" />
							...
							<dd>
                            	<input type="text" class="inputbox autowidth" name="date" value="{$event_field['date']}" id="event_date_update" />
							...
							<dd>
                                <input type="text" class="inputbox autowidth" name="time" value="{date("g:i A", strtotime($event_field['time']))}" id="event_time_update" />
						...
						<dl class="column"> 
							...
							<dd>
                                <input type="text" class="inputbox autowidth" name="goal" value="{$event_field['goal']}" id="event_goal_update" />
							...
							<dd>
                                <input type="text" class="inputbox autowidth" name="deadline" value="{$event_field['deadline']}" id="event_deadline_update" />
							...
							<dd>
								<label for="event_ispublic_yes_update">
									<p><input type="radio" name="is_public" value="1"{if $event_field.permissions eq '1'} checked="checked"{/if} id="event_ispublic_yes_update" /> Anyone can sign up and invite others</p>
								</label> 
								<label for="event_ispublic_no_update">
									<p><input type="radio" name="is_public" value="0"{if $event_field.permissions eq '0'} checked="checked"{/if} id="event_ispublic_no_update" /> Only people you invite can attend</p>
								</label>
