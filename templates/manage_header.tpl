...
<div id="container">
	<header id="header">
		...
		<nav>
			<ul>
				<li{$page['manage']}><a href="{$CURHOST}/event/manage?eventId={$eventInfo['id']}" id="update_event_manage"><span>Manage</span></a></li>
				<li{$page['edit']}><a href="{$CURHOST}/event/edit?eventId={$eventInfo['id']}" id="update_event_edit"><span>Edit</span></a></li>
