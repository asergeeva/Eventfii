<header id="header">
		...
		<nav>
			<ul>
				<li{if isset($page.manage) || isset($page.cp)} class="current"{/if} id="manage"><a href="{$CURHOST}/event/manage?eventId={$smarty.get.eventId}"><span>Manage</span></a></li>
				...
				<li><a href="{$CURHOST}/event/{$smarty.get.eventId}" id="update_event_preview"><span>Preview</span></a></li>
			</ul>
		</nav>
	</header>
