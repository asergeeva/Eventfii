					...
					<fieldset>
						...
						<dl>
							...
							<dd{if isset($error.date) || isset($error.time)} class="error"{/if}>
								...
								<span>{$error.time}</span>{elseif isset($error.date)}

								<span>{$error.date}</span>{elseif isset($error.time)}

								<span>{$error.time}</span>{/if}{if ! isset($event_field.end_date) or $event_field.end_date == ""}
							...
							<dd{if isset($error.end_date) || isset($error.end_time)} class="error"{/if} id="add-end-time"{if ! isset($event_field.end_date) || $event_field.end_date == ""} style="display: none"{/if}>
								...
								<span>{$error.end_time}</span>{elseif isset($error.end_date)}

								<span>{$error.end_date}</span>{elseif isset($error.end_time)}

								<span>{$error.end_time}</span>{/if}
							...
							<dd{if isset($error.address)} class="error"{/if}>
								...
								<span>{$error.address}</span>{/if}{if ! isset($event_field.location)}
