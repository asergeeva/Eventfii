<section class="block">{if ! isset($smarty.get.option) && ! isset($page.addcontacts) && ! isset($page.addguests)}
			...
			<header class="block error">
				<p class="message">{$error2}</p>
			</header>{else if isset($notification)}
