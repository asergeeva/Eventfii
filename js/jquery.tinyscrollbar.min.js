...
function Scrollbar(root, options){
	...
	this.bottom = function(a){
	  OHeight = $(".viewport:first").css("height");
	  var strLen = OHeight.length;
	  myStr = OHeight.slice(0,strLen-2);
	  OHeight = myStr;
	  
	  var noRows = Math.ceil(a/5);
	  iScroller = noRows*160;
	  
	  if(noRows < 4)
	  {
	  	oScrollbar.obj.css('height', iScroller+"px");
	  	oViewport.obj.css('height', iScroller+"px");
	  }else if(noRows == 4)
	  {
		  oScrollbar.obj.css('height', "625px");
	  		oViewport.obj.css('height', "625px");
